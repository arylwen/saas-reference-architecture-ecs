...
export class LambdaControlPlaneNag extends Construct {
  constructor (scope: Construct, id: string) {
    ...
    const sbtPath = '/lambda-controlplane-stack/controlplane-sbt';
    const nagPath = '/lambda-controlplane-stack/AdminWebUi/AdminWebUi';
    const nagSitePath = '/lambda-controlplane-stack/StaticSiteDistro/StaticSiteDistro';
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      cdk.Stack.of(this),
      `/lambda-controlplane-stack/Custom::CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C/ServiceRole/DefaultPolicy/Resource`,
      [
        {
          id: 'AwsSolutions-IAM5',
          reason: 'This is not related with SaaS itself: SBT-ECS SaaS',
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      cdk.Stack.of(this),
      `/lambda-controlplane-stack/Custom::CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C/ServiceRole/Resource`,
      [
        {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      cdk.Stack.of(this),
      `/lambda-controlplane-stack/Custom::CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C/Resource`,
      [
        {
          id: 'AwsSolutions-L1',
          reason: 'CDK S3 Bucket for Ref',
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      cdk.Stack.of(this),
      [
        `/lambda-controlplane-stack/AdminWebUi/AdminSiteSourceCodeBucket/Resource`,
